...
public class MyAnnotationBasedProcessFactory extends AnnotationBasedProcessFactory {

	public MyAnnotationBasedProcessFactory() {
	}

	@Override
	protected String[] getPackages() {
		return new String[] {"org.idempiere.process.annotation.example"};
	}
